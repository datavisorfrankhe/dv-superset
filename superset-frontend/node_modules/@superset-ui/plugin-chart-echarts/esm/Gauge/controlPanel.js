...
import { t, validateNonEmpty, validateInteger, isFeatureEnabled, FeatureFlag } from '@superset-ui/core';
...
const config = {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    }], ['color_scheme'], isFeatureEnabled(FeatureFlag.DASHBOARD_CROSS_FILTERS) ? [{
      name: 'emit_filter',
      config: {
        type: 'CheckboxControl',
