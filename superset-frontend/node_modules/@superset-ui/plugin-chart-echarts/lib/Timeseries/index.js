...
var _TimeSeries_Chart = _interopRequireDefault(require("./images/Time-series_Chart.jpg"));
  ...
  constructor() {
    super({
      ...
      metadata: new _core.ChartMetadata({
        ...
        description: (0, _core.t)('Swiss army knife for visualizing time series data. Choose between  step, line, scatter, and bar charts. This viz type has many customization options as well.'),
        exampleGallery: [{
          url: _TimeSeries_Chart.default
        }],
        ...
        tags: [(0, _core.t)('Advanced-Analytics'), (0, _core.t)('Aesthetic'), (0, _core.t)('ECharts'), (0, _core.t)('Line'), (0, _core.t)('Predictive'), (0, _core.t)('Time'), (0, _core.t)('Transformable'), (0, _core.t)('Highly-used')],
