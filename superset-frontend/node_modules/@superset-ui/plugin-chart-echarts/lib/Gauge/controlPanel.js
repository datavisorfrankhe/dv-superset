...
const config = {
  controlPanelSections: [_chartControls.sections.legacyRegularTime, {
    ...
    controlSetRows: [[(0, _react2.jsx)("h1", {
    ...
    }], ['color_scheme'], (0, _core.isFeatureEnabled)(_core.FeatureFlag.DASHBOARD_CROSS_FILTERS) ? [{
      name: 'emit_filter',
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Enable emitting filters'),
        default: _types.DEFAULT_FORM_DATA.emitFilter,
        renderTrigger: true,
      ...
      config: {
        ...
        description: (0, _core.t)('D3 format syntax: https://github.com/d3/d3-format'),
        freeForm: true,
        renderTrigger: true,
