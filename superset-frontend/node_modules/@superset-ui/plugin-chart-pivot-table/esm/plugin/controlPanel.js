 ...
 * under the License.
 */
import { FeatureFlag, isFeatureEnabled, smartDateFormatter, t, validateNonEmpty } from '@superset-ui/core';
import { D3_TIME_FORMAT_OPTIONS, formatSelectOptions, sections, sharedControls } from '@superset-ui/chart-controls';
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        mapStateToProps(explore) {
          var _ref, _explore$controls, _explore$controls$met, _explore$datasource$v, _explore$datasource;
          ...
          const metricColumn = values.map(value => {
            if (typeof value === 'string') {
              var _verboseMap$value;

              return {
                value,
                label: (_verboseMap$value = verboseMap[value]) != null ? _verboseMap$value : value
              };
            }
